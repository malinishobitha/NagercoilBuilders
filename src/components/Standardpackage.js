...
import standardbannerImage from './images/Standard Package image.png';
    ...
    return (
        <div className="container-Fluid">
               <div className="banner">
                <img src={standardbannerImage}alt="bannerimage"/>
            </div>
            ...
            <div className="package-det">
                ...
                <h2>Package</h2>
                <h3 className="price">
                    <span className="currency">₹</span> 2000
                </h3>
                    ...
                    <div className="Features-det1">
                        ...
                        <div className="Features-details1">
                            ...
                            <div className="package">
                                ...
                                <p>Flooring Tiles (Wall 40 Rs, Floor 60 RS)</p>
                            </div>
                        </div>
                    </div>
                    <div className="Features-det1">
                    ...
                    <div className="Features-det1">
                        ...
                        <div className="Features-details1">
                            ...
                            <div className="package">
                                ...
                                <p>Painting- Wall Putty + Primer</p>
                            </div>
                            <div className="package">
